                  ...
                  <tbody>
                    @for (supplier of suppliers(); track supplier.supplierID) {
                      <tr class="border-t border-t-[#E9DFCE]">
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{supplier.supplierID}}</td>
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{supplier.supplierName}}</td>
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{supplier.contactInfo}}</td>
