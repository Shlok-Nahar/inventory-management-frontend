                ...
                <table class="flex-1">
                  <thead>
                    <tr class="bg-[#FFFFFF]">
                      ...
                      <th class="px-4 py-3 text-left text-[#1C160C] w-[400px] text-sm font-medium">
                  ...
                  <tbody>
                    @for (customer of customers(); track customer.customerID) {
                      <tr class="border-t border-t-[#E9DFCE]">
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{customer.customerID}}</td>
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{customer.customerName}}</td>
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">{{customer.contactInfo}}</td>
                        <td class="h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm text-left">
                          @if (isManageMode()) {
                            <button 
                              class="inline-flex items-center gap-2 bg-[#E9DFCE] hover:bg-[#1C160C] text-[#1C160C] hover:text-white font-bold py-2 px-4 rounded mr-3"
                            ...
                            <button 
                              class="inline-flex items-center gap-2 bg-[#E9DFCE] hover:bg-[#E34234] text-[#1C160C] hover:text-white font-bold py-2 px-4 rounded ml-3"
